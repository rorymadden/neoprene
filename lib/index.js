 ...
 *   options = { eventNodes: false}
 *
 * @param  {Object}   relationship     The id of the relationship and the model type of from and to
...
Neoprene.prototype._removeRelationship = function(relationship, options, callback) {
  ...
  // convert a relationship model to
  // if(typeof relationship.rel === 'object'){
  //   console.log(relationship)
  //   if(relationship.rel.fromType && relationship.rel.toType && relationship.rel._id){
  //     relationship.fromType = relationship.rel.data.fromType;
  //     relationship.toType = relationship.rel.data.toType;
  //     relationship.rel = relationship.rel._id;
  //   }
  //   else if(relationship.rel._id){
  //     relationship.rel = relationship.rel._id;
  //   }
  //   else {
  //     process.nextTick(function() {
  //       callback = relationship;
  //       return callback(
  //         new NeopreneError('Invalid remove relationship request. You need to supply the relationship model or id.'), null);
  //     });
  //   }
  // }
  if(options.eventNodes && !(relationship.fromType && relationship.toType)){
      return callback(
        new NeopreneError('Invalid remove relationship request. You need to supply the model types for froma nd to for the event nodes.'));
  }
