...
var SchemaType = require('../schematype')
  ...
  , NeopreneArray = require('../types/array')
  , Mixed = require('./mixed')
  // , Query = require('../query')
  // , isNeopreneObject = require('../utils').isNeopreneObject
...
function SchemaArray (key, cast, options) {
  ...
  this.default(function(){
    ...
    return new NeopreneArray(arr, self.path, this);
  });
};
...
SchemaArray.prototype.cast = function (value, doc, init) {
  if (Array.isArray(value)) {
    if (!(value instanceof NeopreneArray)) {
      value = new NeopreneArray(value, this.path, doc);
    }
...
//     }
//   }
//   return val && isNeopreneObject(val)
//     ? val.toObject()
//     : val;
// };
