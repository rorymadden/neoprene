...
// exports.loadRelationship = function loadRelationship (obj, base){
//   var relationshipType = obj.type;
//   var modelFrame = base.loadModel(relationshipType);
//   var casted = new modelFrame(obj.data);
//   casted.id = exports.getId(obj.self);
//   casted.self = obj.self;
//   casted.start = exports.getId(obj.start);
//   casted.end = exports.getId(obj.end);
//   casted.type = obj.type;
//   return casted;
// };

// exports.loadNode = function loadNode(obj, base){
//   var nodeType = obj.data.nodeType;
//   var modelFrame = base.loadModel(nodeType);
//   var casted = new modelFrame(obj.data);
//   casted.id = exports.getId(obj.self);
//   casted.self = obj.self;
//   return casted;
...
exports.loadObject = function loadObject (obj, base){
  var type = obj.type ? obj.type : obj.data.nodeType;
